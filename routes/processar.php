...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['tipo'])) {
        ...
        } elseif ($tipo === 'empresa' && !empty($_POST['nome']) && !empty($_POST['email']) && !empty($_POST['senha']) && !empty($_POST['telefone']) && !empty($_POST['cnpj']) && !empty($_POST['queroAjudar']) && !empty($_POST['precisoAjuda'])) {
            
            $empresa = new Empresa($_POST['nome'], $_POST['email'], $_POST['senha'], $_POST['telefone'], $_POST['cnpj'], $_POST['queroAjudar'], $_POST['precisoAjuda']);
